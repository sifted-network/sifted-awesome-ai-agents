...
| 74 | [mini-infer](https://github.com/psmarter/mini-infer) | 270 | 16 | Python | 0 | LLM inference engine from scratch — paged KV cache, continuous batching, chunked prefill, prefix caching, speculative decoding, CUDA graph,  tensor parallelism,  OpenAI-compatible serving  | 2026-04-24 |
...
| 77 | [oramacore](https://github.com/oramasearch/oramacore) | 253 | 23 | Rust | 9 | OramaCore is the complete runtime you need for your projects, answer engines, copilots, and search. It includes a fully-fledged full-text search engine, vector database, LLM interface, and many more u... | 2026-04-14 |
...
| 90 | [llm-systems-engineering-roadmap](https://github.com/h9-tec/llm-systems-engineering-roadmap) | 160 | 22 | - | 0 | A practical roadmap for mastering LLM internals, training, inference, RAG, agents, evaluation, and production architecture. | 2026-04-25 |
...
| 92 | [nanoPD](https://github.com/HJCheng0602/nanoPD) | 156 | 27 | Python | 1 | A from-scratch Prefill/Decode disaggregation inference engine for LLMs | 2026-05-10 |
